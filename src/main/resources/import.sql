...
insert into measurement (id, timestamp, value, sensor_id) values (0, '2021-11-23 20:00:00', 14.7, 0)
insert into measurement (id, timestamp, value, sensor_id) values (1, '2021-11-23 21:00:00', 15.2, 0)
insert into measurement (id, timestamp, value, sensor_id) values (2, '2021-11-23 22:00:00', 16.1, 0)
insert into measurement (id, timestamp, value, sensor_id) values (3, '2021-11-23 23:00:00', 16.9, 0)